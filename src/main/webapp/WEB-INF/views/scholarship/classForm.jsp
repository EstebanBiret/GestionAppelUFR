...
<main>
 ...
 <div class="card">
  <div class="card-header" style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:.75rem">
    <span>
      Étudiants
      <span style="font-weight:400; font-size:.8rem; color:var(--txt-muted); margin-left:.5rem">
   ...
   <form method="post" action="${pageContext.request.contextPath}/scolarite/classes/save-students">
     ...
     <% } else { %>
     <table class="check-table" id="classStudentsTable">
       <thead>
         <tr>
           <th style="cursor:default"></th>
           <th onclick="sortCheckTable('classStudentsTable', 1, this)" data-dir="asc">
             Étudiant <span class="sort-icon">↕</span>
           </th>
           <th onclick="sortCheckTable('classStudentsTable', 2, this)" data-dir="asc">
             Formation <span class="sort-icon">↕</span>
           </th>
           <th onclick="sortCheckTable('classStudentsTable', 3, this)" data-dir="asc">
             Classe actuelle <span class="sort-icon">↕</span>
           </th>
         </tr>
       </thead>
       <tbody id="studentsTbody">
         ...
         <tr class="<%= inThisClass ? "checked-row" : "" %>" onclick="toggleRow(this)">
           ...
           <td data-val="<%= classeLabel != null ? classeLabel : "" %>">
             <% if (classeLabel != null) { %>
     ...
     <div class="form-footer">
       <a href="${pageContext.request.contextPath}/scolarite/classes"
...
<script src="${pageContext.request.contextPath}/js/classForm.js"></script>
</body>
</html>